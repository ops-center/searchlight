...
var map_AWSElasticBlockStoreVolumeSource = map[string]string{
	...
	"volumeID":  "Unique ID of the persistent disk resource in AWS (Amazon EBS volume). More info: http://kubernetes.io/docs/volumes#awselasticblockstore",
	"fsType":    "Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: http://kubernetes.io/docs/volumes#awselasticblockstore",
	...
	"readOnly":  "Specify \"true\" to force and set the ReadOnly property in VolumeMounts to \"true\". If omitted, the default is \"false\". More info: http://kubernetes.io/docs/volumes#awselasticblockstore",
}
...
var map_Container = map[string]string{
	...
	"image":                    "Docker image name. More info: http://kubernetes.io/docs/images",
	"command":                  "Entrypoint array. Not executed within a shell. The docker image's ENTRYPOINT is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: http://kubernetes.io/docs/containers#containers-and-commands",
	...
	"resources":                "Compute Resources required by this container. Cannot be updated. More info: http://kubernetes.io/docs/persistent-volumes#resources",
	"volumeMounts":             "Pod volumes to mount into the container's filesystem. Cannot be updated.",
	"livenessProbe":            "Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: http://kubernetes.io/docs/pod-states#container-probes",
	"readinessProbe":           "Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: http://kubernetes.io/docs/pod-states#container-probes",
	...
	"imagePullPolicy":          "Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: http://kubernetes.io/docs/images#updating-images",
...
var map_ContainerStatus = map[string]string{
	...
	"image":        "The image the container is running. More info: http://kubernetes.io/docs/images",
	"imageID":      "ImageID of the container's image.",
	"containerID":  "Container's ID in the format 'docker://<container_id>'. More info: http://kubernetes.io/docs/container-environment#container-information",
}
...
var map_EmptyDirVolumeSource = map[string]string{
	...
	"medium": "What type of storage medium should back this directory. The default is \"\" which means to use the node's default medium. Must be an empty string (default) or Memory. More info: http://kubernetes.io/docs/volumes#emptydir",
}
...
var map_GCEPersistentDiskVolumeSource = map[string]string{
	...
	"pdName":    "Unique name of the PD resource in GCE. Used to identify the disk in GCE. More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
	"fsType":    "Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
	"partition": "The partition in the volume that you want to mount. If omitted, the default is to mount by volume name. Examples: For volume /dev/sda1, you specify the partition as \"1\". Similarly, the volume partition for /dev/sda is \"0\" (or you can leave the property empty). More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
	"readOnly":  "ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
}
...
var map_HostPathVolumeSource = map[string]string{
	...
	"path": "Path of the directory on the host. More info: http://kubernetes.io/docs/volumes#hostpath",
}
...
var map_ISCSIVolumeSource = map[string]string{
	...
	"fsType":         "Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: http://kubernetes.io/docs/volumes#iscsi",
...
var map_Lifecycle = map[string]string{
	...
	"postStart": "PostStart is called immediately after a container is created. If the handler fails, the container is terminated and restarted according to its restart policy. Other management of the container blocks until the hook completes. More info: http://kubernetes.io/docs/container-environment#hook-details",
	"preStop":   "PreStop is called immediately before a container is terminated. The container is terminated after the handler completes. The reason for termination is passed to the handler. Regardless of the outcome of the handler, the container is eventually terminated. Other management of the container blocks until the hook completes. More info: http://kubernetes.io/docs/container-environment#hook-details",
}
...
var map_NFSVolumeSource = map[string]string{
	...
	"server":   "Server is the hostname or IP address of the NFS server. More info: http://kubernetes.io/docs/volumes#nfs",
	"path":     "Path that is exported by the NFS server. More info: http://kubernetes.io/docs/volumes#nfs",
	"readOnly": "ReadOnly here will force the NFS export to be mounted with read-only permissions. Defaults to false. More info: http://kubernetes.io/docs/volumes#nfs",
}
...
var map_NamespaceList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "Items is the list of Namespace objects in the list. More info: http://kubernetes.io/docs/namespaces",
}
...
var map_NodeStatus = map[string]string{
	...
	"capacity":        "Capacity represents the total resources of a node. More info: http://kubernetes.io/docs/persistent-volumes#capacity for more details.",
...
var map_ObjectMeta = map[string]string{
	...
	"namespace":                  "Namespace defines the space within each name must be unique. An empty namespace is equivalent to the \"default\" namespace, but \"default\" is the canonical representation. Not all objects are required to be scoped to a namespace - the value of this field for those objects will be empty.\n\nMust be a DNS_LABEL. Cannot be updated. More info: http://kubernetes.io/docs/namespaces",
	"selfLink":                   "SelfLink is a URL representing this object. Populated by the system. Read-only.",
	"uid":                        "UID is the unique in time and space value for this object. It is typically generated by the server on successful creation of a resource and is not allowed to change on PUT operations.\n\nPopulated by the system. Read-only. More info: http://kubernetes.io/docs/identifiers#uids",
	...
	"labels":                     "Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/labels",
	"annotations":                "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/annotations",
...
var map_ObjectReference = map[string]string{
	...
	"namespace":       "Namespace of the referent. More info: http://kubernetes.io/docs/namespaces",
	"name":            "Name of the referent. More info: http://kubernetes.io/docs/identifiers#names",
	"uid":             "UID of the referent. More info: http://kubernetes.io/docs/identifiers#uids",
...
var map_PersistentVolume = map[string]string{
	"":         "PersistentVolume (PV) is a storage resource provisioned by an administrator. It is analogous to a node. More info: http://kubernetes.io/docs/persistent-volumes",
	"metadata": "Standard object's metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata",
	"spec":     "Spec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: http://kubernetes.io/docs/persistent-volumes#persistent-volumes",
	"status":   "Status represents the current information/status for the persistent volume. Populated by the system. Read-only. More info: http://kubernetes.io/docs/persistent-volumes#persistent-volumes",
}
...
var map_PersistentVolumeClaim = map[string]string{
	...
	"metadata": "Standard object's metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata",
	"spec":     "Spec defines the desired characteristics of a volume requested by a pod author. More info: http://kubernetes.io/docs/persistent-volumes#persistentvolumeclaims",
	"status":   "Status represents the current information/status of a persistent volume claim. Read-only. More info: http://kubernetes.io/docs/persistent-volumes#persistentvolumeclaims",
}
...
var map_PersistentVolumeClaimList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "A list of persistent volume claims. More info: http://kubernetes.io/docs/persistent-volumes#persistentvolumeclaims",
}
...
var map_PersistentVolumeClaimSpec = map[string]string{
	...
	"accessModes":      "AccessModes contains the desired access modes the volume should have. More info: http://kubernetes.io/docs/persistent-volumes#access-modes-1",
	"selector":         "A label query over volumes to consider for binding.",
	"resources":        "Resources represents the minimum resources the volume should have. More info: http://kubernetes.io/docs/persistent-volumes#resources",
	"volumeName":       "VolumeName is the binding reference to the PersistentVolume backing this claim.",
	"storageClassName": "Name of the StorageClass required by the claim. More info: http://kubernetes.io/docs/persistent-volumes#class-1",
}
...
var map_PersistentVolumeClaimStatus = map[string]string{
	...
	"accessModes": "AccessModes contains the actual access modes the volume backing the PVC has. More info: http://kubernetes.io/docs/persistent-volumes#access-modes-1",
...
var map_PersistentVolumeClaimVolumeSource = map[string]string{
	...
	"claimName": "ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: http://kubernetes.io/docs/persistent-volumes#persistentvolumeclaims",
...
var map_PersistentVolumeList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "List of persistent volumes. More info: http://kubernetes.io/docs/persistent-volumes",
}
...
var map_PersistentVolumeSource = map[string]string{
	...
	"gcePersistentDisk":    "GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. Provisioned by an admin. More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
	"awsElasticBlockStore": "AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://kubernetes.io/docs/volumes#awselasticblockstore",
	"hostPath":             "HostPath represents a directory on the host. Provisioned by a developer or tester. This is useful for single-node development and testing only! On-host storage is not supported in any way and WILL NOT WORK in a multi-node cluster. More info: http://kubernetes.io/docs/volumes#hostpath",
	...
	"nfs":                  "NFS represents an NFS mount on the host. Provisioned by an admin. More info: http://kubernetes.io/docs/volumes#nfs",
...
var map_PersistentVolumeSpec = map[string]string{
	...
	"capacity":                      "A description of the persistent volume's resources and capacity. More info: http://kubernetes.io/docs/persistent-volumes#capacity",
	"accessModes":                   "AccessModes contains all ways the volume can be mounted. More info: http://kubernetes.io/docs/persistent-volumes#access-modes",
	"claimRef":                      "ClaimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim. Expected to be non-nil when bound. claim.VolumeName is the authoritative bind between PV and PVC. More info: http://kubernetes.io/docs/persistent-volumes#binding",
	"persistentVolumeReclaimPolicy": "What happens to a persistent volume when released from its claim. Valid options are Retain (default) and Recycle. Recycling must be supported by the volume plugin underlying this persistent volume. More info: http://kubernetes.io/docs/persistent-volumes#recycling-policy",
...
var map_PersistentVolumeStatus = map[string]string{
	...
	"phase":   "Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: http://kubernetes.io/docs/persistent-volumes#phase",
...
var map_PodCondition = map[string]string{
	...
	"type":               "Type is the type of the condition. Currently only Ready. More info: http://kubernetes.io/docs/pod-states#pod-conditions",
	"status":             "Status is the status of the condition. Can be True, False, Unknown. More info: http://kubernetes.io/docs/pod-states#pod-conditions",
...
var map_PodList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "List of pods. More info: http://kubernetes.io/docs/pods",
}
...
var map_PodSpec = map[string]string{
	...
	"volumes":                       "List of volumes that can be mounted by containers belonging to the pod. More info: http://kubernetes.io/docs/volumes",
	"initContainers":                "List of initialization containers belonging to the pod. Init containers are executed in order prior to containers being started. If any init container fails, the pod is considered to have failed and is handled according to its restartPolicy. The name for an init container or normal container must be unique among all containers. Init containers may not have Lifecycle actions, Readiness probes, or Liveness probes. The resourceRequirements of an init container are taken into account during scheduling by finding the highest request/limit for each resource type, and then using the max of of that value or the sum of the normal containers. Limits are applied to init containers in a similar fashion. Init containers cannot currently be added or removed. Cannot be updated. More info: http://kubernetes.io/docs/containers",
	"containers":                    "List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated. More info: http://kubernetes.io/docs/containers",
	"restartPolicy":                 "Restart policy for all containers within the pod. One of Always, OnFailure, Never. Default to Always. More info: http://kubernetes.io/docs/pod-states#restartpolicy",
	...
	"nodeSelector":                  "NodeSelector is a selector which must be true for the pod to fit on a node. Selector which must match a node's labels for the pod to be scheduled on that node. More info: http://kubernetes.io/docs/node-selection/README",
...
var map_PodStatus = map[string]string{
	...
	"phase":                 "Current condition of the pod. More info: http://kubernetes.io/docs/pod-states#pod-phase",
	"conditions":            "Current service state of pod. More info: http://kubernetes.io/docs/pod-states#pod-conditions",
	...
	"initContainerStatuses": "The list has one entry per init container in the manifest. The most recent successful init container will have ready = true, the most recently started container will have startTime set. More info: http://kubernetes.io/docs/pod-states#container-statuses",
	"containerStatuses":     "The list has one entry per container in the manifest. Each entry is currently the output of `docker inspect`. More info: http://kubernetes.io/docs/pod-states#container-statuses",
...
var map_Probe = map[string]string{
	...
	"initialDelaySeconds": "Number of seconds after the container has started before liveness probes are initiated. More info: http://kubernetes.io/docs/pod-states#container-probes",
	"timeoutSeconds":      "Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: http://kubernetes.io/docs/pod-states#container-probes",
...
var map_RBDVolumeSource = map[string]string{
	...
	"fsType":    "Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: http://kubernetes.io/docs/volumes#rbd",
...
var map_ReplicationControllerList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "List of replication controllers. More info: http://kubernetes.io/docs/replication-controller",
}
...
var map_ReplicationControllerSpec = map[string]string{
	...
	"replicas":        "Replicas is the number of desired replicas. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1. More info: http://kubernetes.io/docs/replication-controller#what-is-a-replication-controller",
	"minReadySeconds": "Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)",
	"selector":        "Selector is a label query over pods that should match the Replicas count. If Selector is empty, it is defaulted to the labels present on the Pod template. Label keys and values that must match in order to be controlled by this replication controller, if empty defaulted to labels on Pod template. More info: http://kubernetes.io/docs/labels#label-selectors",
	"template":        "Template is the object that describes the pod that will be created if insufficient replicas are detected. This takes precedence over a TemplateRef. More info: http://kubernetes.io/docs/replication-controller#pod-template",
}
...
var map_ReplicationControllerStatus = map[string]string{
	...
	"replicas":             "Replicas is the most recently oberved number of replicas. More info: http://kubernetes.io/docs/replication-controller#what-is-a-replication-controller",
...
var map_ResourceRequirements = map[string]string{
	...
	"limits":   "Limits describes the maximum amount of compute resources allowed. More info: http://kubernetes.io/docs/compute-resources/",
	"requests": "Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: http://kubernetes.io/docs/compute-resources/",
}
...
var map_SecretList = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds",
	"items":    "Items is a list of secret objects. More info: http://kubernetes.io/docs/secrets",
}
...
var map_SecretVolumeSource = map[string]string{
	...
	"secretName":  "Name of the secret in the pod's namespace to use. More info: http://kubernetes.io/docs/volumes#secrets",
	"items":       "If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the Secret, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.",
	"defaultMode": "Optional: mode bits to use on created files by default. Must be a value between 0 and 0777. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.",
...
var map_ServiceSpec = map[string]string{
	...
	"sessionAffinity":          "Supports \"ClientIP\" and \"None\". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: http://kubernetes.io/docs/services#virtual-ips-and-service-proxies",
	"loadBalancerIP":           "Only applies to Service Type: LoadBalancer LoadBalancer will get created with the IP specified in this field. This feature depends on whether the underlying cloud-provider supports specifying the loadBalancerIP when a load balancer is created. This field will be ignored if the cloud-provider does not support the feature.",
	"loadBalancerSourceRanges": "If specified and supported by the platform, this will restrict traffic through the cloud-provider load-balancer will be restricted to the specified client IPs. This field will be ignored if the cloud-provider does not support the feature.\" More info: http://kubernetes.io/docs/services-firewalls",
...
var map_Volume = map[string]string{
	...
	"name": "Volume's name. Must be a DNS_LABEL and unique within the pod. More info: http://kubernetes.io/docs/identifiers#names",
}
...
var map_VolumeSource = map[string]string{
	...
	"hostPath":              "HostPath represents a pre-existing file or directory on the host machine that is directly exposed to the container. This is generally used for system agents or other privileged things that are allowed to see the host machine. Most containers will NOT need this. More info: http://kubernetes.io/docs/volumes#hostpath",
	"emptyDir":              "EmptyDir represents a temporary directory that shares a pod's lifetime. More info: http://kubernetes.io/docs/volumes#emptydir",
	"gcePersistentDisk":     "GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://kubernetes.io/docs/volumes#gcepersistentdisk",
	"awsElasticBlockStore":  "AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://kubernetes.io/docs/volumes#awselasticblockstore",
	"gitRepo":               "GitRepo represents a git repository at a particular revision.",
	"secret":                "Secret represents a secret that should populate this volume. More info: http://kubernetes.io/docs/volumes#secrets",
	"nfs":                   "NFS represents an NFS mount on the host that shares a pod's lifetime More info: http://kubernetes.io/docs/volumes#nfs",
	...
	"persistentVolumeClaim": "PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: http://kubernetes.io/docs/persistent-volumes#persistentvolumeclaims",
	"rbd":                  "RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md",
	"flexVolume":           "FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin. This is an alpha feature and may change in future.",
	"cinder":               "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md",
	"cephfs":               "CephFS represents a Ceph FS mount on the host that shares a pod's lifetime",
