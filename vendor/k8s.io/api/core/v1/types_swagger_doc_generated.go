...
var map_EndpointAddress = map[string]string{
	...
	"ip":        "The IP of this endpoint. May not be loopback (128.0.0-rc.0.0/8), link-local (169.254.0.0/16), or link-local multicast ((224.0.0.0/24). IPv6 is also accepted but not fully supported on all platforms. Also, certain kubernetes components, like kube-proxy, are not IPv6 ready.",
