...
func request_PaymentMethods_Check_0(ctx context.Context, marshaler runtime.Marshaler, client PaymentMethodsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterPaymentMethodsHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	client := NewPaymentMethodsClient(conn)

	mux.Handle("GET", pattern_PaymentMethods_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PaymentMethods_Check_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_PaymentMethods_Check_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	forward_PaymentMethods_Check_0 = runtime.ForwardResponseMessage
)
