...
# Deploy Secret
curl https://raw.githubusercontent.com/appscode/searchlight/1.5.7/hack/kubernetes/icinga2/secret.yaml |envsubst | kubectl apply -f -

# Create Service
kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/1.5.7/hack/kubernetes/icinga2/service.yaml

# Create Deployment
kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/1.5.7/hack/kubernetes/icinga2/deployment.yaml
