...
export SEARCHLIGHT_OPERATOR_TAG=8.0.0
export SEARCHLIGHT_ICINGA_TAG=8.0.0-k8s
...
export SCRIPT_LOCATION="curl -fsSL https://raw.githubusercontent.com/appscode/searchlight/8.0.0/"
