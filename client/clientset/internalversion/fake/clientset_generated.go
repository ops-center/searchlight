...
import (
	clientset "github.com/appscode/searchlight/client/clientset/internalversion"
	...
	fakeincidentsinternalversion "github.com/appscode/searchlight/client/clientset/internalversion/typed/incidents/internalversion/fake"
	...
	fakemonitoringinternalversion "github.com/appscode/searchlight/client/clientset/internalversion/typed/monitoring/internalversion/fake"
...
func (c *Clientset) Incidents() incidentsinternalversion.IncidentsInterface {
	return &fakeincidentsinternalversion.FakeIncidents{Fake: &c.Fake}
}

// Monitoring retrieves the MonitoringClient
func (c *Clientset) Monitoring() monitoringinternalversion.MonitoringInterface {
	return &fakemonitoringinternalversion.FakeMonitoring{Fake: &c.Fake}
}
