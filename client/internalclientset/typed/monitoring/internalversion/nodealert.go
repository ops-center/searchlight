...
type NodeAlertInterface interface {
	Create(*monitoring.NodeAlert) (*monitoring.NodeAlert, error)
	Update(*monitoring.NodeAlert) (*monitoring.NodeAlert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*monitoring.NodeAlert, error)
	List(opts v1.ListOptions) (*monitoring.NodeAlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.NodeAlert, err error)
	NodeAlertExpansion
}
...
func newNodeAlerts(c *MonitoringClient, namespace string) *nodeAlerts {
	return &nodeAlerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodeAlerts) Get(name string, options v1.GetOptions) (result *monitoring.NodeAlert, err error) {
	result = &monitoring.NodeAlert{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodealerts").
		Name(name).
...
func (c *nodeAlerts) List(opts v1.ListOptions) (result *monitoring.NodeAlertList, err error) {
	result = &monitoring.NodeAlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodealerts").
...
func (c *nodeAlerts) Create(nodeAlert *monitoring.NodeAlert) (result *monitoring.NodeAlert, err error) {
	result = &monitoring.NodeAlert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodealerts").
...
func (c *nodeAlerts) Update(nodeAlert *monitoring.NodeAlert) (result *monitoring.NodeAlert, err error) {
	result = &monitoring.NodeAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodealerts").
...
func (c *nodeAlerts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.NodeAlert, err error) {
	result = &monitoring.NodeAlert{}
