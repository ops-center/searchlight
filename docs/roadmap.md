...
url: /products/searchlight/6.0.0-alpha.0/welcome/roadmap/
aliases:
  - /products/searchlight/6.0.0-alpha.0/roadmap/
---
...
Searchlight 6.0.0-alpha.0 depends on the following version of Icinga2 and friends:
