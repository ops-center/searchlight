...
```sh
# Deploy Secret
curl https://raw.githubusercontent.com/appscode/searchlight/1.5.3/hack/deploy/icinga2/secret.yaml |
...
```sh
# Create Service
kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/1.5.3/hack/deploy/icinga2/service.yaml
```
...
```sh
# Create Deployment
kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/1.5.3/hack/deploy/icinga2/deployment.yaml
```
