...
```sh
curl https://raw.githubusercontent.com/appscode/searchlight/1.5.8/hack/deploy/icinga2/run.sh | bash
```
...
```sh
# Create Deployment
kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/1.5.8/hack/deploy/searchlight/deployment.yaml
```
