...
// List lists all ClusterAlerts in the indexer.
func (s *clusterAlertLister) List(selector labels.Selector) (ret []*v1alpha1.ClusterAlert, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.ClusterAlert))
	})
	return ret, err
}
...
// List lists all ClusterAlerts in the indexer for a given namespace.
func (s clusterAlertNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ClusterAlert, err error) {
...
// Get retrieves the ClusterAlert from the indexer for a given namespace and name.
func (s clusterAlertNamespaceLister) Get(name string) (*v1alpha1.ClusterAlert, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("clusteralert"), name)
	}
	return obj.(*v1alpha1.ClusterAlert), nil
}
