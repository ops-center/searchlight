...
var Drivers = &driverExt{
	newExtensionPoint(new(Driver)),
}
...
func (ep *driverExt) Unregister(name string) bool {
	return ep.unregister(name)
}

func (ep *driverExt) Register(extension Driver, name string) bool {
	return ep.register(extension, name)
}

func (ep *driverExt) Lookup(name string) Driver {
	ext := ep.lookup(name)
	if ext == nil {
		return nil
	}
...
func (ep *driverExt) Select(names []string) []Driver {
	var selected []Driver
...
func (ep *driverExt) All() map[string]Driver {
...
func (ep *driverExt) Names() []string {
	var names []string
	for k := range ep.all() {
